...
SELECT r1.restaurant_name, r1.restaurant_postal_code, res1.url, res1.address, res1.location, res1.phone, res1.website, res1.timing, res1.cuisine, AVG(r1.food_rating), AVG(r1.service_rating), SUM(r1.recommend=1) / COUNT(r1.recommend), COUNT(r1) 
